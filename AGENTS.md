...
**Room of Days direction (locked):** there is **no companion creature**. The public mark is **Open Door of Light**: one angular dark-walnut threshold, a door held ajar, and one honey-lit path into the room. It advertises the warm little world and earned invitation before it advertises a planner category. The former Day Ledger and isometric room-and-sun marks remain archived provenance only; the literal ledger still belongs to the app's morning, night, and planning surfaces. **The Woven Dawn** remains a permanent room object: it grows with level and never unweaves. It is a quiet long-term record, not the narrator, everyday Quest HUD, or the app's claim about a user's future. Ordinary completions visibly feed XP and the six-stat build; the code-painted room carries long-term change. The fireplace stays ambient furniture, never health or progression. Read `../ART-PIPELINE.md` before touching any art.
