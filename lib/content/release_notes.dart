...
const roomOfDaysReleaseNotes = <RoomReleaseNotes>[
  ...
  RoomReleaseNotes(
    ...
    introduction:
        'Bring in a class schedule with the reminders you want, see what is '
        'next from your Home Screen, and settle into Focus with room music.',
    highlights: <ReleaseHighlight>[
      ReleaseHighlight(
        kind: ReleaseHighlightKind.academicDaybook,
        title: 'A CLASS FILE THAT OPENS HERE',
      ...
      ReleaseHighlight(
        kind: ReleaseHighlightKind.ambientLight,
        title: 'FOCUS, WITH AN EASY WAY OUT',
        body:
            'Room music can keep you company during a timer. One tap makes '
            'the session quiet without changing your main music choice.',
      ),
    ],
  ),
  RoomReleaseNotes(
  ...
  RoomReleaseNotes(
    ...
    introduction:
        'Discovery stays where you set it, every card has its own audience, '
        'and room-code guidance stays clear at larger text.',
    highlights: <ReleaseHighlight>[
      ReleaseHighlight(
        kind: ReleaseHighlightKind.spaceDiscovery,
      ...
      ReleaseHighlight(
        kind: ReleaseHighlightKind.roomGuide,
        title: 'ROOM CODES STAY CLEAR',
        body:
            'Room-code guidance now stays readable above the actions, even with '
            'the largest text on a small screen.',
      ),
    ],
  ),
  RoomReleaseNotes(
