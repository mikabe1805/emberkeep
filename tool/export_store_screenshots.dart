...
const _assets = <_Asset>[
  ...
  _Asset(
    'test/goldens/store_02e_reflection_kept_1290x2796.png',
    'store-assets/screenshots/app-store/02-reward-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_goals_active_1290x2796.png',
    'store-assets/screenshots/app-store/03-goals-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_goals_workshop_1290x2796.png',
    'store-assets/screenshots/app-store/04-workshop-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_goals_recovery_1290x2796.png',
    'store-assets/screenshots/app-store/05-recovery-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_03_daybook_1290x2796.png',
    'store-assets/screenshots/app-store/06-plans-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_14_my_space_cards_1290x2796.png',
    'store-assets/screenshots/app-store/07-my-space-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_03b_conservatory_preview_1290x2796.png',
    'store-assets/screenshots/app-store/08-change-space-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_07_journal_1290x2796.png',
    'store-assets/screenshots/app-store/09-journal-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
    'test/goldens/store_07_discover_1290x2796.png',
    'store-assets/screenshots/app-store/10-discover-1290x2796.png',
    1290,
    2796,
  ),
  _Asset(
